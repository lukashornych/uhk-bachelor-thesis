...
\projectinfo{
  ...
  title.cs={Webové technologie},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  title.en={Web technologies}, % název práce v angličtině / thesis title in english
  %Autor / Author
  ...
  supervisor.surname={Macinka},   % příjmení školitele / supervisor surname
  supervisor.title.p={Ing.},   %titul před jménem (nepovinné) / title before the name (optional)
  % Klíčová slova / keywords
  keywords.cs={web, technologie, server, klient, backend, frontend, server-side, client-side}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={web, technologies, server, client, backend, frontend, server-side, client-side}, % klíčová slova v anglickém jazyce / keywords in english
  % Anotace
  annotation.cs={
    Seminární práce se zabývá charakteristikou webových technologií a výběrem nejvhodnějších pro implementaci moderní webové aplikace
    ...
    Práce nejprve popisuje dostupné webové technologie na trhu a jejich výhody a nevýhody a na závěr se věnuje výběru úzké skupině
    technologií splňující určité požadavky.
  },
