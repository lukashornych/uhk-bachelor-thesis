...
\projectinfo{
  ...
  keywords.cs={web, technologie, server, klient, backend, frontend, server-side, client-side, databáze, fulltext, transakční emaily, souborové úložiště, UI, UX}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={web, technologies, server, client, backend, frontend, server-side, client-side, database, fulltext, transactional emails, file storage, UI, UX}, % klíčová slova v anglickém jazyce / keywords in english
  % Anotace
  annotation.cs={
