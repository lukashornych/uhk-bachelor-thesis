...
jan_novak
		...
		\cntcapfigure{proces_reindexace_na_urovni_es}{5cm}{Ukázka procesu hromadné reindexace dat na úrovni Elasticsearch.}{[autor]}
		...
		\cntcapfigure{proces_reindexace_z_db}{5cm}{Ukázka procesu hromadné reindexace nových dat z primární databáze.}{[autor]}
...
accounts:
	...
	subscription:
		...
		\cntcapfigure{datovy_model_nastaveni_aplikace}{\linewidth}{Ukázka datového modelu nastavení aplikace.}{[autor]}
...
ENTRYPOINT yarn start --dotenv=.env.$ENV
		...
		\cntcapfigure{architektura_produkce}{\linewidth}{Ukázka putování HTTP požadavku infrastrukturou.}{[autor]}
