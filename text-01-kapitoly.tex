...
většinu požadavků soukromých osob, firem a objektů.
	...
	Kategorizační štítky budou sloužit pro globální kategorizaci karet, aby měl uživatel povědomí, o jakou kartu se jedná
	...
	Důležitou informací pro firmy, události, pobočky atd. je geografická lokace sídla.
...
Následně je již možné začít se samotnou implementací s pomocí vybraných technologií a prototypu \ac{UI}.
	...
	poměrně velkou částí samotného vývoje.
		...
		\subsubsection{Vybrané technologie}
			...
			Protože bude aplikace pracovat se zaregistrovanými uživateli, bude potřeba uživatelům odesílat transakční emaily
	...
	mezer a prvků a základní pravidla, jako je pozicování tlačítek, rozvržení seznamů, modální okna a podobně.
		...
		Kromě linek a stínů je dobré myslet i na samotné okraje prvků, tedy jestli budou mít zaoblené rohy, či nikoli.
		...
		rozvržení stránek.
			...
			Stránky jsou rozvrženy hlavně pomocí tzv. bloků obsahu označujících jeden logický celek informací
			na stránce.
			...
			Kromě hlavní navigační lišty aplikace bylo nutné zavést ještě jeden typ lišty - lištu akcí.
			...
			Jedná se o malé menu zobrazující rozšířené možnosti nějaké akce.
