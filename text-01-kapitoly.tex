...
Následně je již možné začít se samotnou implementací s pomocí vybraných technologií a prototypu \ac{UI}.
	...
	\subsection{Implementace API serveru}
		...
		\subsection{Práce s datovým modelem}
		...
		Pro tento projekt byla využita knihovna Hibernate Validator využívající Java anotace pro specifikování pravidel.
		...
		\subsection{Šablony odkazů sítí}
		...
		\subsection{GDPR}
		 ...
		 todo stránkování,mail, search, sercurity,storage, validation, app config, plány, generování bezpečných tokenů
